...
\begin{tikzpicture}
    ...
    \node[align=center] (0) at (3, 0) {\includegraphics[width=.3\textwidth]{static/memory_two.png}};
    ...
    % \node[align=center] (0) at (9, 0) {\includegraphics[width=.3\textwidth]{static/two_bits.png}};
    ...
    % \node[align=center] (0) at (16, 0) {\includegraphics[width=.13\textwidth]{static/two_bits.png}};
    % \node[align=center] (0) at (12.5, -1.2) {\includegraphics[width=.01\textwidth]{static/medal.png}};
